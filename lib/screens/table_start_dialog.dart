...
/// نفس فكرة _StartModeDialog في الأجهزة
...
class _TableStartDialogState extends State<TableStartDialog> {
  ...
  Widget _buildStep0(Color color, int rate) {
    // سعر المالتي = سعر العادي + 30% تقريباً (لو مش محدد خصيصاً)
    // التربيزات مش فيها فرق سعري في الـ app_state حالياً
    // بس بنعرض الـ mode عشان يتحفظ في سجل الجلسة
    return Column(
